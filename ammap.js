...
(function () {
    ...
    d.processObject = function (a, b, c, e) {
        if (!1 === a instanceof b && (a = e ? d.extend(new b(c), a) : d.extend(a, new b(c), !0), a.listeners))
            for (var f in a.listeners) b = a.listeners[f], a.addListener(b.event,
                b.method);
        return a
    };
        ...
        if (a) {
            ...
            if (0 !== b)
                if ("[object Array]" === Object.prototype.toString.call(a))
                    ...
                    for (c in a.theme = null, a) a[c] && ("object" == typeof a[c] &&
                    d.deleteObject(a[c], b - 1), "function" != typeof a[c] && (a[c] = null))
                } catch (e) {
                }
        }
    };
    ...
    d.generateNumber = function (a, b) {
        ...
        var d;
        for (d = 0; d < e; d++) c += "0";
        return 0 > b ? Number("0." + c + String(a)) :
            Number(String(a) + c)
    };
    ...
    d.parseDefs = function (a, b) {
        for (var c in a) {
            ...
            if (0 < a[c].length && "object" == e)
                for (var f = 0; f < a[c].length; f++) e = document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[c][f],
                    e);
        ...
        draw: function () {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    this.drop ? (h = z / 1.6, l = 0, "V" == u && (u = "down"), "H" == u && (u = "left"), "down" == u && (x = a + 1, A = b - h - h / 3), "up" == u && (l = 180, x = a + 1, A = b + h + h / 3), "left" == u && (l = 270, x = a + h + h / 3 + 2, A = b), "right" == u && (l = 90, x = a - h - h / 3 + 2, A = b), k = A - E / 2 + 1, m = x - F / 2 - 1, p = d.drop(f, h, l, p, y, q, t, L)) : 0 < w || 0 === B ? (0 < G && (a = d.rect(f,
